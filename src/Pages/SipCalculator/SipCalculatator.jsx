...
const SipCalculatator = () => {
  ...
  return (
    <div className="mx-2">
      <p className="text-blue-950 font-semibold text-xl my-2 ">
      ...
      <section className="my-5 flex flex-col gap-4 p-2 border-[2px] border-solid border-gray-300 rounded">
        ...
        <div className="h-[70px] flex flex-col justify-between">
          <aside className="flex justify-between items-end relative">
            ...
            <input
              ...
              onChange={(e) =>
                handleInputChange(e, setExpectedReturn, setExpectedReturnSlider)
              }
              className="bg-slate-100 text-right px-1 pr-8 rounded items-end h-[30px] w-[150px]"
            />
            <span className="absolute right-2 p-[2px] font-semibold italic text-green-700">
          ...
          <input
            ...
            onChange={(e) =>
              handleSliderChange(e, setExpectedReturn, setExpectedReturnSlider)
            }
            className="bg-slate-100 text-right  rounded items-end w-full"
          />
        </div>
      ...
      <section className="my-5 flex flex-col  p-2 border-[2px] border-solid border-gray-300 rounded">
        <div className="w-full">
          ...
          />{" "}
          <span className="absolute right-6 p-[2px] font-semibold italic text-green-700">
            Rs
          </span>
        </div>
        <div className="w-full">
      ...
      <aside className="overflow-auto">
        <div className={`${timePeriod > 20 ? "w-[1000px]" : "w-full"}`}>
          <ReactApexChart
            options={{
              chart: {
                type: "bar",
